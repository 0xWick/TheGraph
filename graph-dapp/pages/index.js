import { BigNumber, BigNumbers, Contract, ethers, providers, utils } from "ethers";
...
export default function Home() {
  ...
  // walletConnected keep track of whether the user's walelt is connected or not
  ...
  // in our case we will use force to update to show new logs
